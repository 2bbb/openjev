...
The generative path emitted its first token at a median 0.489 seconds and then visibly streams its recorded answer. The direct output appears together at its measured completion point. Short labels make the questions readable. The animation preserves the measured median timing ratio while making the full race practical to watch.

Included project-owned media:

- `assets/openjev-phase1-replay.gif` — 15-second GitHub README hero.
- `assets/openjev-phase1-replay.webm` — 1280 × 720 VP9 replay.
- `assets/openjev-phase1-replay-poster.png` — poster frame.
- `assets/openjev-social-preview.png` — 1200 × 630 social preview.
